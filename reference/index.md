...
from figshare and Fire Occurrence Database (FOD) datasets from the
Forest Service Research Data Archive, and read the downloaded archives
as spatial objects with optional year filtering.
