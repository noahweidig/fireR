...
- 🛡️ **Safe checks** — all `get_*()` functions support `dry_run = TRUE`
  to safely preview cache paths before downloading.
...
> **Warning:** The FOD ZIP is approximately 175 MB. Downloads may be
